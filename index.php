    ...
    <main>
        <section class="conteudo-principal">
            <div class="conteudo-principal-escrito">
                ...
                <h2 class="conteudo-principal-escrito-subtitulo">    A turma PSI5 da ESCO preparou uma Lan-Party que irá decorrer nas horas de aulas com objetivo de reunir maior número de pessoas para se defrontarem em um torneio de CS:GO. <br> Podes Ler mais <a href="sobre.php" style="color:white">aqui</a>!</h2>
